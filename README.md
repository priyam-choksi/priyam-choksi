...
| **Agentic Customer Triage** | 27-category routing at **91% accuracy**; resolves **74% of 2,000+ monthly tickets** without escalation; LangGraph travel graph + 3-agent banking chain | [Repo](https://github.com/priyam-choksi/agentic-customer-triage-system) |
...
| **Multi-omics Pipeline** | BWH/Harvard genomic pipeline: **48–72h → 15 min** on 5.8TB; throughput 2–3 → 10–15 analyses/week (code confidential per BWH policy) | [Site](https://priyamchoksi.com/#/projects) |
